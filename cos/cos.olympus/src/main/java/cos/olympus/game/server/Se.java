...
public class Se {
    ...
    private void readOP(SelectionKey key) {
        try {
            ...
            if (numRead == -1) {
                this.keepDataTrack.remove(ch);
                System.out.println("Connection closed by: " + ch.getRemoteAddress());
                ch.close();
                key.cancel();
                return;
            }
            ...
            System.out.println(new String(data, "UTF-8") + " from " + ch.getRemoteAddress());
